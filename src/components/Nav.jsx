        ...
        <div className={`navbar1-collapse ${navbarOpen ? "show" : ""}`}>
          <ul className="navbar-nav2">
            ...
            <li className="nav-item dropdown">
              <button 
                className={`nav-link2 dropdown-toggle ${dropdownOpen === "admin" ? "open" : ""}`} 
                onClick={() => toggleDropdown("admin")}
              >
                Administration
              </button>
              <ul className={`dropdown-menu3 ${dropdownOpen === "admin" ? "show" : ""}`}>
                <li><Link className="dropdown-item4" to="/ourparish" onClick={closeMenu}>Parish</Link></li>
                <li><Link className="dropdown-item4" to="/anbiyangal" onClick={closeMenu}>Anbyangal</Link></li>
              </ul>
            </li>
            ...
            <li className="nav-item dropdown">
              <button 
                className={`nav-link2 dropdown-toggle ${dropdownOpen === "gallery" ? "open" : ""}`} 
            ...
            <li className="nav-item">
              <Link className="nav-link2" to="/contact" onClick={closeMenu}>Contact Us</Link>
            </li>
          </ul>
        </div>
      </div>
