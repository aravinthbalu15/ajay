...
const One = () => {
  return (
    <div className="pt-5">
      ...
      {/* Container 1 */}
      <h1 className="section-title mt-5">மரியாவின் சேனை</h1>
      ...
      {/* Container 2 */}
      <h1 className="section-title mt-5">வன்சென்ட் தே பால் சங்கம்</h1>
      <div className="body-wrapper">
        <div className="body-container">
          <div className="text-section">
            <p className="description">
      ...
      {/* Container 3 */}
      <h1 className="section-title mt-5">கதோலிக்க சேவை சங்கம்</h1>
      <div className="body-wrapper">
        <div className="body-container">
          <div className="text-section">
            <p className="description">
